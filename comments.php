...
<div id="respond" class="no_webshot">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		<div class="comt">
			...
			<div class="comt-box">
				<textarea placeholder="<?php echo _hui('comment_text') ?>" class="input-block-level comt-area OwO-textarea" name="comment" id="comment" cols="100%" rows="3" tabindex="1" onkeydown="if(event.ctrlKey&amp;&amp;event.keyCode==13){document.getElementById('submit').click();return false};"></textarea>
				<div class="comt-ctrl">
                    ...
                    <div class="position">
								  <link rel="stylesheet" href="https://www.wc1234.cn/wp-content/themes/dux/css/OwO.min.css">
                      	 <div class="OwO"></div>
									<script src="https://www.wc1234.cn/wp-content/themes/dux/js/OwO.min.js"></script>
									<script>
											var OwO_demo = new OwO({
												logo: 'OωO表情',
												container: document.getElementsByClassName('OwO')[0],
												target: document.getElementsByClassName('OwO-textarea')[0],
												api: 'https://www.wc1234.cn/wp-content/themes/dux/js/OwO.json',
												position: 'down',
												width: '100%',
												maxHeight: '250px'
											});
                        ...
                        <a href="javascript:SIMPALED.Editor.daka()" title="打卡"><b><i class="fa fa-telegram"></i></b></a>
