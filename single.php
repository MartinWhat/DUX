...
<section class="container">
	...
	<div class="content">
		...
		<article class="article-content wow pulse">
		...
		<?php if( _hui('post_copyright_s') ){
			echo '<div class="post-copyright">本文基于《知识共享署名-相同方式共享 3.0 中国大陆许可协议》发布，转载请遵循本协议<br>本文链接:  <a href="' . get_permalink() . '">' . get_permalink() . '</a>  (转载时请注明本文出处及文章链接)</div>';
		} ?>
		<?php endwhile; ?>
