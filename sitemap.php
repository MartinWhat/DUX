...
<center></center>
<div id="nav"><a href="<?php bloginfo('url'); ?>/"><strong><?php bloginfo('name'); ?></strong></a> &raquo; <a href="<?php echo get_permalink(); ?>">SiteMap</a></div>
<div id="content">
<h3>最新文章</h3>
<ul>
<?php
...
<center>
<div style="text-algin: center; font-size: 11px">Powered by <strong><a href="https://www.wenzika.com/" target="_blank">文字咖</a></strong>&nbsp;&nbsp;&nbsp;&nbsp;
